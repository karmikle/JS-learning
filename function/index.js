...
console.log( arrowFunc(3, 4) );  // shorter varriant of function below (function expr);
...
let olyaFunk = function() {
    console.log("olya");
}

let arrowFunc2 = ( c, d ) => c + d; 
let arrowFunc3 = ( c, d ) => { // the same as above
    debugger;
    return c + d;
}
